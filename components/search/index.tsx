...
import * as FileSystem from 'expo-file-system/legacy'; // IMPORTAÇÃO CORRIGIDA para o módulo legado
...
export default function Search() {
  ...
  const handleDownload = async () => {
    ...
    try {
      ...
      const downloadUrl = `${SERVER_URL}download`; // Usa a SERVER_URL importada
